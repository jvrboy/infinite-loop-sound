    ...
    <AppShell>
      <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Project your long-term account growth through the power of compounding.</p>
        </div>
          ...
          <div className="bg-card border border-border p-5 rounded-lg space-y-4 h-fit">
            ...
            <div className="pt-4 mt-4 border-t border-border">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono font-bold text-lg">${finalBalance.toLocaleString()}</span>
              </div>
            </div>
          </div>

          <div className="md:col-span-2 bg-card border border-border p-5 rounded-lg">
            <h3 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-4">Growth Projection</h3>
            <div className="h-72 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <YAxis tick={{fill: "var(--muted-foreground)", fontSize: 11}} tickFormatter={(v) => `$${v}`} width={60} />
                  <Tooltip 
                  ...
                  />
                  <Area type="monotone" dataKey="balance" stroke="var(--primary)" fillOpacity={1} fill="url(#colorBal)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
