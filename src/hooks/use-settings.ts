...
const DEFAULTS: AppLocalSettings = {
  telegramChartSnapshots: true, liveTickRescan: true, aiConfluenceEnabled: true,
  weightFib: 1, weightSD: 1, weightOrderFlow: 1, weightVolumeProfile: 1,
  spreadPips: 1.0, slippagePips: 0.5, execDelayBars: 0,
  tickThrottleMs: 150,
};
